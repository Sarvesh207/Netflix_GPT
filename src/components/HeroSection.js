...
const HeroSection = () => {
  return (
    <>
    <div className='lg:h-[45.5em] md:h-[30em]' style={{background: `linear-gradient(80deg,black,transparent), url(${BG_URL})`}}>
      <Navbar/>
      <div className=" container mx-auto flex justify-center items-center min-96 ">
        <div className=" ">
