...
//     <div>
//       <Header />
//       <div className="absolute w-[100%] h-[100vh] bg-center">
//         <img
//           src={BG_URL}
//           alt="background_logo"
...
//         className=" w-full md:w-3/12 xl: absolute p-12 bg-black my-36 mx-auto right-0 left-0 text-white bg-opacity-80"
//       >
